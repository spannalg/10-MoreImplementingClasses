...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         and Luke Spannan.
         Help received from CSSE tutors, and CSSE 120 students James Werne and Zane Blair
...
class CapitalT(object):
    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def set_colors(self, fill_color, outline_color):
        ...
        self.v_rect.outline_color = outline_color
        self.v_f_c= fill_color
        self.h_f_c=fill_color
        self.v_o_c = outline_color
        self.h_o_c =outline_color
    ...
    def clone(self):
        ...
        #######################################################################
        C_T= CapitalT(self.i, self.w,((self.h)//2),self.t)
        C_T.set_colors(self.v_rect.fill_color,self.v_rect.outline_color)
        C_T.set_colors(self.v_rect.fill_color, self.v_rect.outline_color)
        return C_T
